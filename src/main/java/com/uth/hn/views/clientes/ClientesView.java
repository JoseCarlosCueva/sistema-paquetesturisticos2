...
public class ClientesView extends Composite<VerticalLayout> {
    ...
    public ClientesView() {
        ...
        textField3.setPattern("^[+]?[(]?[0-9]{3}[)]?[-s.]?[0-9]{4}[-s.]?[0-9]{4}$");
        textField3.setAllowedCharPattern("[0-9()+-]");
        textField3.setMinLength(8);
    ...
    private void setComboBoxSampleData(ComboBox comboBox) {
        ...
        sampleItems.add(new SampleItem("Femenino", "Femenino", Boolean.TRUE));
